...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _register() async {
    ...
    try {
      Account account = Account(AppwriteService.instance.getClient);

      final credential = await account.create(
          userId: ID.unique(),
          email: _usernameController!.text,
          password: _passwordController!.text,
          name: '${_firstName??'Not'} ${_lastName??'Provided'}'
      );

      await AppwriteChatCore.instance.createUserInAppWrite(
        types.User(
      ...
      models.Account currentUser = await account.get();
      AppwriteChatCore.instance.setUser(currentUser);
